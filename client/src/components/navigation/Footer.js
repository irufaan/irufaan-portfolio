...
const Footer = () => (
    <div className="footer">
        ...
        <a href="https://www.youtube.com/" rel="noopener noreferrer" target="_blank"><i className="fab fa-youtube footer__icons__icon"></i></a>
            <a href="https://twitter.com/" rel="noopener noreferrer" target="_blank"><i className="fab fa-twitter footer__icons__icon"></i></a>
            <a href="https://github.com/irufaan" rel="noopener noreferrer" target="_blank"><i className="fab fa-github footer__icons__icon"></i></a>
            <a href="https://www.linkedin.com/in/irufaan" rel="noopener noreferrer" target="_blank"><i className="fab fa-linkedin footer__icons__icon"></i></a>
        </div>
