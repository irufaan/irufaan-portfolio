...
const API_KEY = process.env.youTubeKey || 'AIzaSyAWEbAsQG098LegcULmgb43IO1jZdm2_AU';
const results = 12;


const YTsearchURL = `https://www.googleapis.com/youtube/v3/search?key=${API_KEY}&channelId=UCnj8dl6NWgASf4kKZLuuwfw&part=snippet&maxResults=${results}`;
